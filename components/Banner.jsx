...
const Banner = ({ parentStyles, name, childStyles }) => (
  <div className={`nft-gradient relative z-0 flex w-full items-center overflow-hidden ${parentStyles}`}><p className={`font-poppins text-5xl font-bold leading-70 ${childStyles}`}>{name}</p>
